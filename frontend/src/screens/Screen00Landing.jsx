    ...
    <div className="space-y-6 animate-fadeIn pb-12">
      ...
      <div className="relative rounded-lg bg-[#141414] border border-[#2a2a2a] p-6 md:p-8">
        <div className="relative z-10 max-w-4xl space-y-4">
          <div className="inline-flex items-center space-x-2 px-2.5 py-1 rounded bg-[#1c1c1c] border border-[#2a2a2a] text-slate-500 text-[11px] font-mono">
            <Sparkles className="w-3.5 h-3.5 text-cyan-500" />
            <span>SIH ISRO CHANDRAYAAN-2 LUNAR IMAGE REGISTRATION SUITE</span>
          </div>

          <h1 className="text-2xl md:text-3xl font-display font-bold text-slate-100 tracking-tight leading-snug">
      ...
      <div className="grid grid-cols-2 md:grid-cols-4 gap-3">
        <div className="bg-[#141414] border border-[#2a2a2a] rounded-md p-4">
          <div className="text-slate-500 text-[10px] font-mono">SUB-PIXEL PRECISION</div>
          <div className="text-xl md:text-2xl font-display font-semibold text-cyan-400 mt-1.5">
        ...
        <div className="bg-[#141414] border border-[#2a2a2a] rounded-md p-4">
          <div className="text-slate-500 text-[10px] font-mono">SUN ANGLE TOLERANCE</div>
          <div className="text-xl md:text-2xl font-display font-semibold text-slate-300 mt-1.5">
        ...
        <div className="bg-[#141414] border border-[#2a2a2a] rounded-md p-4">
          <div className="text-slate-500 text-[10px] font-mono">GRID SPATIAL COVERAGE</div>
          <div className="text-xl md:text-2xl font-display font-semibold text-emerald-400 mt-1.5">
        ...
        <div className="bg-[#141414] border border-[#2a2a2a] rounded-md p-4">
          <div className="text-slate-500 text-[10px] font-mono">ISRO PHOTOGRAMMETRY</div>
          <div className="text-xl md:text-2xl font-display font-semibold text-slate-300 mt-1.5">
      ...
      <div id="problem-statement" className="space-y-3 pt-2">
        <h2 className="text-base font-display font-semibold text-slate-200 flex items-center space-x-2">
          <ShieldCheck className="w-4 h-4 text-cyan-500" />
          <span>Core Challenges &amp; Automated Solutions</span>
        </h2>

        <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
          <div className="bg-[#141414] border border-[#2a2a2a] rounded-md p-5 space-y-2.5">
            <div className="flex items-center space-x-2.5">
              <Sun className="w-4 h-4 text-cyan-500 shrink-0" />
              <h3 className="text-sm font-display font-semibold text-slate-200">1. Illumination Variation (Shadow Rotation)</h3>
            </div>
          ...
          <div className="bg-[#141414] border border-[#2a2a2a] rounded-md p-5 space-y-2.5">
            <div className="flex items-center space-x-2.5">
              ...
              <h3 className="text-sm font-display font-semibold text-slate-200">2. Scale &amp; Viewpoint Adaptation</h3>
            </div>
            <p className="text-slate-400 text-[13px] leading-relaxed">
          ...
          <div className="bg-[#141414] border border-[#2a2a2a] rounded-md p-5 space-y-2.5">
            <div className="flex items-center space-x-2.5">
              ...
              <h3 className="text-sm font-display font-semibold text-slate-200">3. Uniform Tie-Point Spatial Distribution</h3>
            </div>
            <p className="text-slate-400 text-[13px] leading-relaxed">
          ...
          <div className="bg-[#141414] border border-[#2a2a2a] rounded-md p-5 space-y-2.5">
            <div className="flex items-center space-x-2.5">
              ...
              <h3 className="text-sm font-display font-semibold text-slate-200">4. ISIS Control Network Output</h3>
            </div>
            <p className="text-slate-400 text-[13px] leading-relaxed">
